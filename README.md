...
Before we proceed with the next steps go to a browser window and type in 127.0.0.1 to test that IIS is running and turned on.
<p>
...
https://github.com/AaronGuajardo2/Osticket-PostInstall-Config
